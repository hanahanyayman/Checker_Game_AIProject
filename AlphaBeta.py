...
def AlphaBeta(board, Depth, Player, Alpha, Beta):
    ...
    if Player == 'B':
        ...
        for i in range(0, len(Children)):
            max_value_of_children = AlphaBeta(Children[i], Depth - 1, 'R', Alpha, Beta)
        ...
        value = 10000000000000000
        for i in range(0, len(Children)):
            min_value_of_children = AlphaBeta(Children[i], Depth - 1, 'B', Alpha, Beta)
...
if __name__ == "__main__":
    ...
    while utility(tempboard,'R') == 0 and tempboard != None:
        print("B play ...")
        tempboard = AlphaBeta(tempboard,depth,'B',Alpha,Beta)
        if tempboard !=None:
           Assign(tempboard)
